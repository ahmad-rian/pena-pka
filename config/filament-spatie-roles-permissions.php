...
return [
    ...
    // if false guard option will not be shown on screen. You should set a default_guard_name in this case
    'should_show_guard' => true,

    'model_filter_key' => 'return \'%\'.$value.\'%\';', // Adjusted to include '%' in the filter key
    ...
    'generator' => [
        ...
        /*
         * Define any other permissions that should be synced with the DB
         */
        'custom_permissions' => [
            //'view-log'
        ],
